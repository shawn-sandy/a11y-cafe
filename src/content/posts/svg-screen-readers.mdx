---
title: 'Screen Reader Behavior with SVG Title and Desc attributes.'
pubDate: 2024-06-23
description: 'Understand how to ensure your SVGs are accessible across different screen readers.'
summary: Not all screen readers handle SVG `<title>` and `<desc>` elements consistently. Here's a summary of how major screen readers interact with these elements. Understand how to ensure your SVGs are accessible across different screen readers.
...
Not all screen readers handle SVG `<title>` and `<desc>` elements consistently. Here's a summary of how major screen readers interact with these elements. We help you understand how to ensure your SVGs are accessible across different screen readers.
