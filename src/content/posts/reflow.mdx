...
### 1.4.10 Reflow
**Guideline:** Content should be presented without requiring horizontal scrolling.
**Success Criterion:** 1.4.10 Reflow (Level AA)
**Best Practice:** Ensure that content can be resized and reflowed to fit different screen sizes and orientations without horizontal scrolling up to 400% zoom.
...
<body>
  <div class="container">
    <div class="item">Item 1: Resize the browser window to see how this item reflows.</div>
    <div class="item">Item 2: Resize the browser window to see how this item reflows.</div>
  </div>
</body>
</html>
```
...
- <a href="https://www.w3.org/WAI/WCAG21/quickref/?versions=2.2#reflow" target="_blank">WCAG 2.2 Quick Reference: Reflow</a>
- <a href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/Understanding_WCAG/Perceivable/Reflow" target="_blank">MDN Web Docs: Understanding Reflow</a>
- <a href="https://webaim.org/techniques/responsive/" target="_blank">WebAIM: Responsive Design</a>
