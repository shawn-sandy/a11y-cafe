...
pubDate: 2024-07-07
description: 'Empty and nested HTML `<div>` elements can create significant accessibility challenges. '
...
- [Using ARIA: Roles and Properties](https://www.w3.org/WAI/ARIA/apg/practices/names-and-roles/)
